...
type ComplexityRoot struct {
	Mutation struct {
		Verify func(childComplexity int, score string) int
	}
...
type MutationResolver interface {
	Verify(ctx context.Context, score string) (*model.Verify, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Verify.combinations":
		if e.complexity.Verify.Combinations == nil {
			break
		}

		return e.complexity.Verify.Combinations(childComplexity), true
...
func (ec *executionContext) _Mutation_verify(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		return ec.resolvers.Mutation().Verify(rctx, fc.Args["score"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	fc.Result = res
	return ec.marshalNVerify2ᚖgithubᚗcomᚋbrandaogabriel7ᚋstudioᚑsolᚑbackendᚑtestᚑ2ᚋgraphᚋmodelᚐVerify(ctx, field.Selections, res)
}
...
func (ec *executionContext) fieldContext_Mutation_verify(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		...
		Child: func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			switch field.Name {
			case "combinations":
				return ec.fieldContext_Verify_combinations(ctx, field)
			}
...
func (ec *executionContext) _Verify_combinations(ctx context.Context, field graphql.CollectedField, obj *model.Verify) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_Verify_combinations(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
...
func (ec *executionContext) fieldContext_Verify_combinations(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Verify",
		Field:      field,
		IsMethod:   false,
...
func (ec *executionContext) _Verify(ctx context.Context, sel ast.SelectionSet, obj *model.Verify) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "combinations":
			out.Values[i] = ec._Verify_combinations(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				out.Invalids++
			}
		default:
...
func (ec *executionContext) marshalNVerify2githubᚗcomᚋbrandaogabriel7ᚋstudioᚑsolᚑbackendᚑtestᚑ2ᚋgraphᚋmodelᚐVerify(ctx context.Context, sel ast.SelectionSet, v model.Verify) graphql.Marshaler {
	return ec._Verify(ctx, sel, &v)
}

func (ec *executionContext) marshalNVerify2ᚖgithubᚗcomᚋbrandaogabriel7ᚋstudioᚑsolᚑbackendᚑtestᚑ2ᚋgraphᚋmodelᚐVerify(ctx context.Context, sel ast.SelectionSet, v *model.Verify) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
